...
**Step 1**
```
Add natasha to sarah’s group + fix directory group perms. to fix the permssion issu

If you want both users to share access safely:

1️⃣ Add natasha to sarah’s group:

sudo usermod -aG sarah natasha


2️⃣ Set group write permission on the repo:

sudo chmod -R g+w /var/www/html

3️⃣ Set gid-inheritance (new files inherit group):
            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        echo "Deployment Completed for branch ${BR}"
                    """
                }
            }
        }
